export const articles = [
  {
    id: 1,
    title: "Why Naruto: Saihen?",
    slug: "whynarutosaihen",
    subtitle: null,
    sections: [
      {
        heading: "The Goal",
        ...
        list: [
          {
            title: "Less shōnen.",
            description: [
              "The power-level is pulled back hard. No meteors. No izanagi. No Kurama vs Susano'o gundam fights. No infinite tsukiyomis. Fights are not about who can ass-pull the hardest.",
          ...
          {
            title: "Clearer villains.",
            description: [
              "Orochimaru → Pain → Madara. That's it. Kaguya and the Ōtsutsuki are relegated to in-universe myth and history; they'll serve purely as texture.",
              "Pain seeks to eliminate bijū by killing jinchūriki. Madara seeks conquest. No metaphysical gymnastics are to be performed by any party."
            ]
          },
          {
